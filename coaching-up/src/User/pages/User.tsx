...
import { AccountType, ListingTags, TimeIntervals } from '../../Types/EnumTypes';
...
function UserPage() {
    ...
    const listingBody : ListingBody = {title: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed venenatis", description: description, tags: [ListingTags.Hybrid, ListingTags.InPerson], coach: coach, price: priceInfo};
